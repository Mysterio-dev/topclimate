    ...
    (() => {
            ...
            if (spollersArray.length > 0) {
                ...
                function setSpollerAction(e) {
                    ...
                    if (el.closest("[data-spoller]")) {
                        ...
                        const spollerSpeed = spollersBlock.dataset.spollersSpeed ? parseInt(spollersBlock.dataset.spollersSpeed) : 200;
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                ...
                } else if (!e.target.closest(".menu") && document.documentElement.classList.contains("menu-open")) {
...
***************************************************************************** */
        ...
        let x;
        if (countdownElement) {
            const deadline = new Date("Oct 1, 2023 00:00:00").getTime();
            function updateCountdown() {
                ...
                if (distance <= 0) {
                    ...
                    const hours = Math.floor(distance / (1e3 * 60 * 60));
            ...
            updateCountdown();
            x = setInterval(updateCountdown, 1e3);
        } else console.error("Элемент с id 'countdown' не найден на странице.");
        window["FLS"] = true;
        isWebp();
        menuInit();
        spollers();
